		...
		<div id="root-wrapper">
			...
			<div id="content-wrapper">
				...
				<div id="main-content">
					...
					<form name= "formtran" id="formulario" action="./apply_edit_sale.php" method="post" onsubmit="return validar()">
						...
						<br><br>
						CUIT (cliente):<input type="text" name="cuit-cli" id="cuit-cli" size="11" maxlength="11" value="{{ rows.CCUIT }}" />
