		...
		<div id="root-wrapper">
			...
			<div id="content-wrapper">
				...
				<div id="main-content">
					...
					<form name= "formtran" id="formulario" action="./apply_new_purchase.php" method="post" onsubmit="return validar()" >
						...
						<br><br> 
						Color: <select id="opc" name="color">
							<option></option>
						...
						<br><br>
						Especie: <select id="ope" name="especies">
							<option></option>
